<template>
    <span class="cursor-pointer inline p-1 hover:bg-gray-200 rounded-lg">
        <font-awesome-icon :icon="['fas', 'eye-slash']" v-if="skipped" @click="skipWord" />
        <font-awesome-icon :icon="['fas', 'eye']" v-else @click="skipWord" />
    </span>
</template>
<script>
